...
* [square]#▢# Use `langgraph.prebuilt.create_react_agent` to build the compiled agent graph
* [square]#▢# Implement `run_chat_loop` using the compiled graph's `stream` method
* [square]#▢# Implement `send` method using the compiled graph's `invoke` method
